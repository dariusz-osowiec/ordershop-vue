<template>
  ...
  <h3>Polityka prywatności serwisu <b>OrderShop</b></h3>
  <div class="small-divider"></div>
  <div style="text-align: left">
    <ul>
      <li>
        <p>
          ...
          usług poprzez Serwis
        </p>
      </li>
      <li>
        <p>Administratorem danych osobowych zawartych w serwisie jest serwis OrderShop</p>
      </li>
      <li>
        <p>
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            <p>poprzez gromadzenie plików “cookies” [patrz polityka plików “cookies”].</p>
          </li>
        </ul>
      </li>
      <li>
      ...
      <li>
        <p>
          Do danych zawartych w formularzu przysługuje wgląd osobie fizycznej, która je
      ...
      <li>
        <p>
          Zastrzegamy sobie prawo do zmiany w polityce ochrony prywatności serwisu, na
      ...
      <li>
        <p>
          ...
          przez serwis OrderShop. Strony te mogą posiadać własne polityki dotyczące
    ...
    <div class="">
      <h6>
        ...
        jesteśmy do dyspozycji - proszę użyć formularza kontaktowego na głównej stronie.
      </h6>
    </div>
  </div>
</template>
...
export default {
  name: "PrivacyView",
  created() {
    document.title = "Polityka prywatności";
  },
};
</script>
